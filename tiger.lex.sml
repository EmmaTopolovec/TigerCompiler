...
fun yyAction44 (strm, lastMatch : yymatch) = (yystrm := strm;
      (string := ""; in_string := true; string_yypos := yypos; YYBEGIN STRING; continue()))
...
fun yyAction52 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; in_string := false; Tokens.STRING(!string, !string_yypos, yypos)))
...
fun yyAction54 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos ("Error: Invalid escape character"); continue()))
...
fun yyAction56 (strm, lastMatch : yymatch) = (yystrm := strm;
      (comment := !comment+1; YYBEGIN COMMENT; continue()))
fun yyAction57 (strm, lastMatch : yymatch) = (yystrm := strm;
      (comment := !comment+1; continue()))
fun yyAction58 (strm, lastMatch : yymatch) = (yystrm := strm;
      (comment := !comment-1; if !comment > 0 then continue() else (YYBEGIN INITIAL; continue())))
...
fun yyAction61 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("Error: Invalid Character " ^ yytext); continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction42(strm, yyNO_MATCH)
                      else yyQ61(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ103(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ61(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
              else yyAction42(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ42 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction36(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ105(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ106(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
...
fun yyQ38 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction19(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ108(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
            ...
            if inp = #"\\"
              ...
              then if inp = #"!"
                  ...
                  then if inp = #"\v"
                      ...
                      then if inp <= #"\b"
                          then yyAction54(strm, yyNO_MATCH)
                          else yyQ7(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                    else if inp = #" "
              ...
              then if inp = #"_"
                  ...
                  then if inp = #"]"
                      then yyAction54(strm, yyNO_MATCH)
                      else yyQ11(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                else if inp = #"f"
                  then yyQ7(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                  else yyAction54(strm, yyNO_MATCH)
            else if inp = #"o"
